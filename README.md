This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-shipwire.

Cenit is an open source social platform as a service for data and business integration.

# CenitCollectionShipwire
...
Or install it yourself as:
    ...
    $ gem install cenit-collection-shipwire
...
% tree
.
├── cenit-collection-cenit-collection-shipwire.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-shipwire
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-shipwire.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-shipwire_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
...
1. Fork it ( https://github.com/[my-github-username]/cenit-collection-shipwire/fork )
